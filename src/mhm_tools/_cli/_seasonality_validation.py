...
def add_args(parser):
    ...
    """
    parser.add_argument("--input_path", help="Path to the input file. Or the dictionary containing all folders with input files.", required=True)
    ...
    parser.add_argument("--ref_path", help="Path to the first reference file. Or the dictionary containing all folders with ref files.", default=None, required=False)
