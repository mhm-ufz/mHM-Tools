...
def add_args(parser):
    ...
    req.add_argument('--ref_input_dir',    required=True, help='Directory with reference NetCDF files')
    req.add_argument('--mod_input_dir',    required=True, help='Directory with model NetCDF files')
    req.add_argument('--reference_pattern',required=True, help='Wildcard for reference file')
    ...
    req.add_argument('-o', '--output_dir', required=True, help='Directory to save the output PNG')
    req.add_argument('--output_file',      required=True, help='Filename for the output PNG')

    # optional arguments
    parser.add_argument('--colorbar_label', default='Difference (model − reference)',
                        help='Label for the plot colorbar')
    parser.add_argument('--title',          default='Mean Difference (model − reference)',
                        help='Title for the plot')
    parser.add_argument('--x_min',          type=str2float, default=None,
                        help='Minimum longitude to display')
    parser.add_argument('--x_max',          type=str2float, default=None,
                        help='Maximum longitude to display')
    parser.add_argument('--y_min',          type=str2float, default=None,
                        help='Minimum latitude to display')
    parser.add_argument('--y_max',          type=str2float, default=None,
    ...
    parser.add_argument('--vmin',           type=str2float, default=None,
                        help='Minimum data value for colormap (optional)')
    parser.add_argument('--vmax',           type=str2float, default=None,
